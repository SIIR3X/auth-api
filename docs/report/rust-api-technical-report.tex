...
\textbf{Version:} & 0.1.0 \\
\textbf{Scope:} & Schema, backend architecture, benchmarks, and deployment \\
\end{tabular}
...
the Rust codebase and the HTTP surface, and documents the self-hosted deployment
model built around Docker, PostgreSQL, Redis, Nginx, \texttt{pass}, and
\texttt{cryptsetup}. The report is intended to serve as a durable engineering
reference for maintenance, onboarding, performance work, and release operations.
\end{minipage}}
