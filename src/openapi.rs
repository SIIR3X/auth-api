...
#[openapi(
    ...
    paths(
        ...
        crate::handlers::external_identity::providers,
        crate::handlers::external_identity::start_sign_in,
        crate::handlers::external_identity::callback,
        crate::handlers::external_identity::complete_sign_in,
        crate::handlers::external_identity::list,
        crate::handlers::external_identity::start_link,
        crate::handlers::external_identity::complete_link,
        crate::handlers::external_identity::unlink,
        ...
        crate::handlers::personal_access_token::exchange,
        ...
        crate::handlers::admin::roles::create,
        crate::handlers::admin::roles::set_permissions,
        crate::handlers::admin::roles::delete,
        crate::handlers::admin::roles::assign,
        crate::handlers::admin::roles::unassign,
        crate::handlers::admin::clients::list,
        crate::handlers::admin::clients::save,
        crate::handlers::admin::clients::delete,
        crate::handlers::admin::clients::rotate_secret,
        crate::handlers::admin::clients::remove_secret,
    ...
    tags(
        ...
        (name = "external-identities", description = "Signing in with Google, GitHub or an OpenID Connect provider, and linking them to an account"),
